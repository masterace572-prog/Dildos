...
TOKEN = '7704220520:AAEI_ouYgKUdt52-ec9JJDjdo44pme781Ls'
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DDOSSOSOSOSKSJS/11*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*NOT WORKING? USE INSTANT ++ METHOD \n For Issue or help dm @Anony1764*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*ADMINS - \n @Anony1764 \n @Pampa_ji_op*", parse_mode='Markdown')
    else:
